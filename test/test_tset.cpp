...
// ---------------------------------------------------------------------------
TEST(TSet, compare_of_set_is_true)
{
  const int size = 5;
  TSet set1(size), set2(size);
...
// ---------------------------------------------------------------------------
TEST(TSet, compare_of_set_is_false)
{
  const int size = 5;
  TSet set1(size), set2(size);
...
// ---------------------------------------------------------------------------
TEST(TSet, operator_is_not_equal_of_set_is_true)
{
  const int size = 5;
  TSet set1(size), set2(size);
...
// ---------------------------------------------------------------------------
TEST(TSet, operator_is_not_equal_of_set_is_false)
{
  const int size = 5;
  TSet set1(size), set2(size);
